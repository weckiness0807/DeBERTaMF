...
parser.add_argument("-c", "--do_preprocess", type=bool,
                    help="True or False to preprocess raw data for DeBERTaMF (default = False)", default=False)
...
parser.add_argument("-g", "--give_item_weight", type=bool,
                    help="True or False to give item weight of DeBERTaMF (default = False)", default=True)
...
if do_preprocess:
  ...
  # train
    ...
    print ("===================================DeBERTaMF Option Setting===================================")
    ...
    DeBERTa_X = D_all['X_sequence']
    
    vocab_size = len(D_all['X_vocab']) + 1

    from models import DeBERTaMF
    ...
    DeBERTaMF(max_iter=max_iter, res_dir=res_dir,
           lambda_u=lambda_u, lambda_v=lambda_v, dimension=dimension, init_W=init_W, give_item_weight=give_item_weight, DeBERTa_X=DeBERTa_X, 
